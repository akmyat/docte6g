 ...
 *
 * To run: ./example-ns3sionna-sensing.sh
 */
...
main(int argc, char* argv[])
{
    ...
    if (tracing) // Tracing
    {
        ...
        spectrumPhy.EnablePcap("example-ns3sionna-sensing", staDevices.Get(0));
        spectrumPhy.EnablePcap("example-ns3sionna-sensing", staDevices.Get(1));
    }
