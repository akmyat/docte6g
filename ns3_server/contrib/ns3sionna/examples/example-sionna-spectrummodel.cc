...
#include "ns3/ns3sionna-phased-array-spectrum-propagation-loss-model.h"
...
main(int argc, char* argv[])
{
    ...
    if (tracing)
    {
        ...
        spectrumPhy.EnablePcap("example-ns3sionna-spectrummodel", apDevices.Get(0));
        spectrumPhy.EnablePcap("example-ns3sionna-spectrummodel", staDevices.Get(0));
        spectrumPhy.EnablePcap("example-ns3sionna-spectrummodel", staDevices.Get(1));
    }
