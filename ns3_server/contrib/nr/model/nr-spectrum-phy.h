...
class NrSpectrumPhy : public SpectrumPhy
{
  public:
    // AKM Edit Start
    void SetUeEnergyPhyListener (NrUeEnergyModelPhyListener listener);
    void SetGnbEnergyPhyListener (NrGnbEnergyModelPhyListener listener);
    // AKM Edit End
    /**
  ...
  private:
    // AKM Edit Start
    NrUeEnergyModelPhyListener m_ue_energy_listener;
    NrGnbEnergyModelPhyListener m_gnb_energy_listener;
    // AKM Edit End
