...
NrSpectrumPhy::ChangeState(State newState, Time duration)
{
    ...
    // AKM Edit Start
    if (m_isGnb) {
        m_gnb_energy_listener.NotifyStateChange(newState, duration);
    } else {
        m_ue_energy_listener.NotifyStateChange(newState, duration);
    }
    // AKM Edit End
}
...
// AKM Edit Start
void
NrSpectrumPhy::SetUeEnergyPhyListener (NrUeEnergyModelPhyListener listener) {
    m_ue_energy_listener = listener;
}
void
NrSpectrumPhy::SetGnbEnergyPhyListener (NrGnbEnergyModelPhyListener listener) {
    m_gnb_energy_listener = listener;
}
// AKM Edit End
