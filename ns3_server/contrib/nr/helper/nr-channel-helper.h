...
class NrChannelHelper : public Object
{
  public:
    ...
    // AKM Edit Start
    /**
    * @brief Set an attribute for the PathDelayModel, before the spectrum channel has been created
    * @param n The name of the attribute
    * @param v The value of the attribute
     */
     void SetPathDelayAttribute(const std::string& n, const AttributeValue& v);
    // AKM Edit End
  ...
  private:
    ...
    // AKM Edit Start
    ObjectFactory m_pathDelayModel;        //!< The path delay object factory
    // AKM Edit End
    Ptr<WraparoundModel>
