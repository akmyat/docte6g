        ...
        TypeId("ns3::NrChannelHelper")
            ...
            .AddAttribute("Scenario",
                          ...
                          MakeEnumChecker(NrChannelHelper::Scenario::InF,
                                          ...
                                          "NTN-Rural",
                                          // AKM Edit Start
                                          NrChannelHelper::Scenario::Sionna,
                                          "Sionna",
                                          // AKM Edit End
            ...
            .AddAttribute(
                ...
                MakeEnumChecker(NrChannelHelper::ChannelModel::ThreeGpp,
                                ...
                                "NYU",
                                // AKM Edit Start
                                NrChannelHelper::ChannelModel::Sionna,
                                "Sionna",
                                // AKM Edit End
...
NrChannelHelper::CreateChannel(uint8_t flags)
{
    ...
    if (flags & INIT_PROPAGATION && m_pathLossModel.IsTypeIdSet())
    {
        ...
        // AKM Edit Start
        if (m_pathDelayModel.IsTypeIdSet()) {
            channel->SetPropagationDelayModel(m_pathDelayModel.Create<PropagationDelayModel>());
        }
        // AKM Edit End
    }
                                    ...
                                    std::string ChannelModel)
{
    ...
    // AKM Edit Start
    if(m_channelModel == ChannelModel::Sionna) {
        m_pathDelayModel.SetTypeId(TypeId::LookupByName("ns3::SionnaPropagationDelayModel"));
    } else {
        m_pathDelayModel.SetTypeId(TypeId::LookupByName("ns3::ConstantSpeedPropagationDelayModel"));
    }
    // AKM Edit End
}
...
// AKM Edit Start
void
NrChannelHelper::SetPathDelayAttribute(const std::string& n, const AttributeValue& v)
{
    NS_ABORT_MSG_IF(!m_pathDelayModel.IsTypeIdSet(), "Set the path delay model first");
    m_pathDelayModel.Set(n, v);
}
// AKM Edit End
...
NrChannelHelper::GetChannelModelTypeId() const
{
    static std::map<ChannelModel, TypeId> lookupTable{
        ...
        // AKM Edit Start
        {ChannelModel::Sionna, TypeId::LookupByName("ns3::SionnaSpectrumPropagationLossModel")},
        // AKM Edit End
    };
...
NrChannelHelper::GetConditionTypeId() const
{
    static std::map<Condition, TypeId> lookupTable{
        ...
        // AKM Edit Start
        {Condition::Sionna, TypeId::LookupByName("ns3::SionnaChannelConditionModel")},
        // AKM Edit End
...
NrChannelHelper::GetPropagationTypeId() const
{
    ...
    static std::map<std::pair<ChannelModel, Scenario>, std::pair<TypeId, TypeId>> lookupTable{
        ...
        {{ChannelModel::NYU, Scenario::InH},
         ...
         // AKM Edit Start
         {{ChannelModel::Sionna, Scenario::Sionna}, 
         {TypeId::LookupByName("ns3::SionnaPropagationLossModel"), TypeId::LookupByName("ns3::SionnaChannelConditionModel")}},
         // AKM Edit End
